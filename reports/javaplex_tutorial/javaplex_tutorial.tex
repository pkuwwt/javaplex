...
The persistence algorithm that computes barcodes can also find a representative cycle for each barcode. We do several examples of this in Section \ref{explicitStream}. However, there is no guarantee that the produced representative will be geometrically nice. 
